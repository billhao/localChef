...
- (NSString*)publishItem:(FoodItem*)food {
    ...
    // [reqStr stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]  ]; // does not escape &, change to the one below
    reqStr = [self URLEncodedString_ch:reqStr];
